var Compat = {
	createShadowRoot: function (e) { return e.createShadowRoot(); },
...
Widgets.KeyChanger.init = function (impl) {
	Widgets.KeyChanger.css =
		...
		'.key{width:40px;height:25px;background-image:url(' + chrome.extension.getURL('resources/shadowcrypt/Spritesheet-01.png') + ');}\r\n' +
		...
		'.lock{position:absolute;bottom:-20px;left:-20px;width:40px;height:40px;background:-160px -120px url(' + chrome.extension.getURL('resources/shadowcrypt/Spritesheet-01.png') + ');cursor:pointer;}\r\n' +
...
Startup.init = function () {
	...
	Startup.name = 'origin-'+"https://mail.google.com";
